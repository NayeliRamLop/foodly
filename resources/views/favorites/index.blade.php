...
@section('content_header')
    <h1 class="m-0 text-dark" style="font-size: 2.8rem;">
        <i class="fas fa-heart mr-2" style="color: #dc3545;"></i>Mis Recetas Favoritas
...
<div class="row">
    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100 recipe-card" data-recipe-id="{{ $recipe->id }}">
            ...
            <div class="card-body">
                <h5 class="card-title" style="color: #7a9cc6; font-weight: 600; font-size: 1.3rem;">{{ $recipe->recipe_title }}</h5>
